package com.singhnextjuggernaut.ajeetkumar.sharemydevice.utils;
...
public class Foreground implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityResumed(final Activity activity) {
        ...
        if (wasBackground) {
            Log.i(TAG, activity.getString(R.string.went_foreground));
            ...
            Log.i(TAG, activity.getString(R.string.still_foreground));
        }
    }
        ...
        check = new Runnable() {
            ...
            public void run() {
                if (foreground && paused) {
                    foreground = false;
                    Log.i(TAG, activity.getString(R.string.went_background));
                    for (Listener l : listeners) {
                        if (l != null) {
